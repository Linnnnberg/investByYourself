...
export default function HomePage() {
  ...
  // Mock portfolios data for demo (API endpoint not available yet)
  const mockPortfolios: Portfolio[] = [
    ...
    },
    {
      ...
      description: 'Stable income focus',
      total_value: '$85,000',
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Welcome to InvestByYourself</h1>
                <p className="text-gray-600">Your comprehensive investment platform</p>
              </div>
              <div className="flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => window.location.href = '/investment-profile'}>
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => window.location.href = '/companies'}>
                <CardContent className="text-center p-6">
                  <div className="text-4xl mb-2">🔍</div>
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => window.location.href = '/portfolio'}>
                <CardContent className="text-center p-6">
                  <div className="text-4xl mb-2">💼</div>
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => window.location.href = '/dashboard'}>
                <CardContent className="text-center p-6">
                  <div className="text-4xl mb-2">📈</div>
                  <h3 className="text-lg font-semibold mb-2">View Dashboard</h3>
                  <p className="text-gray-600">See your data summary</p>
                </CardContent>
              </Card>
            </div>
                      ...
                      {portfolios.map((portfolio) => (
                        <div key={portfolio.id} className="p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="mt-2 text-sm text-gray-500">
                            Risk: {portfolio.risk_profile} • Status: {portfolio.status} • Holdings: {portfolio.holdings_count}
                          </div>
                        </div>
                      ))}
                    </div>
