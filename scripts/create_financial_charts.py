...
fig.suptitle(
    "Comprehensive Financial Analysis: AAPL vs MSFT (2022-2024)",
    fontsize=18,
    fontweight="bold",
    y=0.98,
)
...
margin_2024 = df[df["Year"] == "2024"][
    ["Company", "Gross_Margin", "Operating_Margin", "Net_Profit_Margin"]
]
margin_data = margin_2024.melt(
...
axes[0, 1].set_title(
    "2024 Profitability Margins Comparison", fontsize=14, fontweight="bold"
)
...
heatmap_data = df.pivot_table(
    index="Company",
    columns="Year",
    values=["Gross_Margin", "Operating_Margin", "Net_Profit_Margin"],
)
heatmap_data.columns = [
    f'{col[1]} {col[0].replace("_", " ")}' for col in heatmap_data.columns
]
...
summary_melted = summary_2024.melt(
    id_vars=["Company"], var_name="Metric", value_name="Value"
)
...
print(
    "Comprehensive financial analysis charts saved as: comprehensive_financial_analysis.png"
)

# Create a simplified version for the markdown
fig2, axes2 = plt.subplots(1, 2, figsize=(14, 6))
fig2.suptitle(
    "AAPL vs MSFT: Key Financial Metrics Comparison", fontsize=16, fontweight="bold"
)
