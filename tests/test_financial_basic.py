...
class TestFinancialCalculations:
    ...
    def test_portfolio_value_calculation(self):
        ...
        calculated_value = sum(holding['shares'] * holding['price'] for holding in holdings)
        
        assert abs(calculated_value - expected_value) < 0.01
        assert calculated_value == 15700.0
    ...
    def test_percentage_change_calculation(self):
        ...
        percentage_change_negative = ((new_value_negative - old_value) / old_value) * 100
